   ...
   <div class="container">
      <div class="header-wrapper">
         ...
         <ul class="main-menu">
               ...
               <ul class="sub-menu">
                  ...
                  <?php if (isset($_GET["pagina"])) : ?>
                     ...
                     <?php if ($_GET["pagina"] == "salir") : ?>
                           <li class="nav-item">
                              <a class="nav-link active" href="index.php?pagina=salir">Exit</a>
                           </li>
                     <?php else: ?>
                           <li class="nav-item">
                              <a class="nav-link" href="index.php?pagina=salir">Exit</a>
                           </li>
                     <?php endif ?>
            ...
            <li <?= isset($_GET["pagina"]) && $_GET["pagina"] == "home" ? 'class="active"' : '' ?>>
